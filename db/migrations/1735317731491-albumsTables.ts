...
export class AlbumsTables1735317731491 implements MigrationInterface {
    name = 'AlbumsTables1735317731491'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "album-track" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "lyrics" text, "audioUrl" character varying NOT NULL, "audioId" character varying NOT NULL, "trackPlacement" integer NOT NULL, "albumId" integer, CONSTRAINT "PK_29df0a9e04d6104956aa8a3188e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "album-owners" ADD CONSTRAINT "FK_069754bb2ce6ea7aede074277b8" FOREIGN KEY ("albumId") REFERENCES "album"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
