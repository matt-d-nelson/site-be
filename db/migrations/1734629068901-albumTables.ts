...
export class AlbumTables1734629068901 implements MigrationInterface {
    name = 'AlbumTables1734629068901'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "album" ("id" SERIAL NOT NULL, "isDraft" boolean NOT NULL, "name" character varying NOT NULL, "description" text NOT NULL, "coverArtUrl" character varying NOT NULL, "coverArtId" character varying NOT NULL, "releaseDate" character varying NOT NULL, CONSTRAINT "PK_58e0b4b8a31bb897e6959fe3206" PRIMARY KEY ("id"))`);
